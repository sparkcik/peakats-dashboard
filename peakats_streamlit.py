"""
PEAKATS Recruiter Dashboard - Streamlit Version
...
def get_database_connection():
    ...
    db_path = os.getenv(
        "PEAKATS_DB",
        "/Users/charles/Library/CloudStorage/GoogleDrive-charles@thefoundry.llc/My Drive/PEAK/#PEAKATS/00_SYSTEM/peakats.db"
    )
...
def update_gcic(candidate_id, checked):
    ...
    cursor.execute("""
        ...
        SET gcic_uploaded = ?,
            ...
            updated_at = datetime('now')
        WHERE id = ?
    """, (1 if checked else 0, upload_date, candidate_id))
    conn.commit()
    ...
    with tab1:
        ...
        if len(filtered_df) == 0:
            ...
            display_df = filtered_df[[
                'flag', 'first_name', 'last_name', 'client_id', 'initiated', 'recruiter_notes',
            ...
            # Rename columns
            display_df.columns = [
                '🚩', 'First Name', 'Last Name', 'Client', 'Initiated', 'Notes',
